...
int main(){
    ...
    switch(operation){
    	...
    	printf("o resultado da ação escolhida é:/The result for the chosen action is: %f \n", result);
    	break;
    	case 2:
    	result = number1 - number2;
    	printf("o resultado da ação escolhida é:/The result for the chosen action is: %f \n", result);
	...
	printf("deseja continuar ou sair? Digite 1 para continuar ou 2 para sair:/Do you wanna keep or leave? Type 1 to keep or 2 to leave: \n");
	scanf("%d", &operation);
	if(operation==1){
		system("cls");
		goto inicio;
